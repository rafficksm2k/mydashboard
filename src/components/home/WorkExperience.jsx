      ...
      <Col md={12}>
        <VerticalTimeline>
          <VerticalTimelineElement
            ...
            contentArrowStyle={{
              borderRight: "7px solid  rgba(30, 68, 72, 1)",
            }}
            date="2018 - 2023"
          ...
          >
            <h3 className="vertical-timeline-element-title">
              <strong className="purple">System Analyst @IBM</strong>
            </h3>
            ...
            <p>
              React JS | Javascript | NodeJS | Docker | IBM Openshift | NPM |
              Jenkins | JIRA
            </p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            ...
            contentStyle={{ background: "rgba(30, 68, 72, 1)", color: "#fff" }}
            contentArrowStyle={{
              borderRight: "7px solid  rgb( 30, 68, 72, 1)",
            }}
            date="2010 - 2017"
          ...
          >
            <h3 className="vertical-timeline-element-title">
              <strong className="purple">
                Senior Software Engineer @Photon Interactive
              </strong>
            </h3>
            <h4 className="vertical-timeline-element-subtitle">
              Chennai, India
          ...
          >
            <h3 className="vertical-timeline-element-title">
              <strong className="purple">B.Tech - IT</strong>
            </h3>
            <h4 className="vertical-timeline-element-subtitle">
              SSNCE - Chennai
            </h4>
